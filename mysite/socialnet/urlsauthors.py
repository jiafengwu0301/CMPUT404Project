...
urlpatterns = [
	...
	url(r'^(?P<pk>\d+)/friends/$', viewsauthors.FriendsAuthorView.as_view(), name='author_friends'),
	url(r'^friend_requests/$', viewsauthors.FriendRequestsAuthorView.as_view({'put':'add_friend_request', 'get': 'list'}), name='author_friends_requests'),
